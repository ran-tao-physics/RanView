...
class PPMSdummyWidget(TabWidget, QtWidgets.QWidget):
    ...
    def __init__(self, name, instrument=None, refresh_time=0.2, check_interval=30, parent=None):
        super().__init__(name, parent)
        self.instrument = instrument
        self.refresh_time = refresh_time # default is 0.2s refresh rate
    ...
    def _setup_ui(self):
        self.delay = 1 # delay time in sending GPIB command
    ...
    def update_status(self):
        ...
        self.temperatureentry.setText(timestr)
        self.temperaturestatusentry.setText(timestr)
        self.fieldentry.setText(timestr)
        self.magnetstatusentry.setText(timestr)
        self.pressureentry.setText(timestr)
        self.heliumentry.setText(timestr)
        self.chamberentry.setText(timestr)
    ...
    def preview_widget(self, parent=None):
        ...
        """
        return PPMSdummyWidget("PPMS control preview",
                                        instrument=None,
                                        parent=parent,
                                    )
